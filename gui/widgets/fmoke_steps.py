...
class ApplySteps(QWidget):
    ...
    def __init__(self, moke, data_folder=''):
        super().__init__()
        self.setWindowTitle('FMOKE - apply field steps experiment ')
        self.moke = moke
    ...
    def create_experiment_params_dict(self):
        ...
        expprms['nb_steps_per_loop'] = self.params.child("Signal", "Predefined signals", "Number of points per repetition").value()
