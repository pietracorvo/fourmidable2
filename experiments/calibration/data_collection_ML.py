...
def calibrate_hallprobe(moke, fname, period=5, cutoff_freq=5, plot=False):
    ...
    print('Signal is of type ', type(signal))
...
if __name__ == "__main__":
    ...
    with Moke() as moke:
        for i in range(n_measurements):
            fnamee = 'HallprobeCalib{a}.h5'.format(a=i)
            calibrate_hallprobe(moke, fnamee, period=20)
            time.sleep(60)
